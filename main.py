...
def get_car_price_prediction(
    ...
    # Seller adjustment (Dealer vs Individual)
    if seller_individual == 0:

        if final_price_toman < 500:
            final_price_toman += 20

        elif final_price_toman < 1000:
            final_price_toman += 30

        elif final_price_toman < 2000:
            final_price_toman += 50

        elif final_price_toman < 3000:
            final_price_toman += 75

        elif final_price_toman < 4000:
            final_price_toman += 105

        elif final_price_toman < 5000:
            final_price_toman += 135

        else:
            final_price_toman += final_price_toman * 0.03
            ...
            ScrollView:
                MDBoxLayout:
                    ...
                    MDTextField:
                        ...
                        helper_text: "10.0 for 10000 Dollar"
